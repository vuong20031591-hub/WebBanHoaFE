...
import { BloomRewardsModal } from "./BloomRewardsModal";
        ...
        <div className="relative min-h-[175px] overflow-hidden rounded-[24px] bg-[#fef5f6] px-8 py-8">
          <div className="relative z-10 max-w-[184px]">
            ...
            <button
              ...
              className="mt-[23px] text-[10px] font-bold uppercase tracking-[1px] text-[#d0bb95] transition-colors hover:text-[#c2a571]"
            >
              {rewards.ctaLabel}
            </button>
          </div>
