...
import { currencySymbolForLocale } from "@/lib/currency";
...
export function ProductFilter({
  ...
  const currencySymbol = currencySymbolForLocale(locale);
  ...
  return (
    <aside className="w-full shrink-0 lg:w-[224px]">
      ...
      <div className="h-10 bg-[rgba(156,163,175,0.2)] rounded flex items-center px-3">
        ...
        <input
          type="text"
          placeholder={t("products.filter.searchByName")}
          value={name}
      ...
      <div className="flex items-center gap-2">
        <div className="flex-1 h-10 bg-[rgba(156,163,175,0.2)] rounded flex items-center px-3">
          <span className="text-[#9ca3af] text-[14px] mr-1" style={{ fontFamily: "var(--font-inter)" }}>{currencySymbol}</span>
          <input
            type="number"
            placeholder="0"
            value={minPrice}
        ...
        <div className="flex-1 h-10 bg-[rgba(156,163,175,0.2)] rounded flex items-center px-3">
          ...
          <input
            type="number"
            placeholder={locale === "en" ? "20" : "500000"}
            value={maxPrice}
